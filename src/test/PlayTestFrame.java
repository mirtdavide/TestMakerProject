...
public class PlayTestFrame extends JFrame {
    ...
    public PlayTestFrame(String path, String n, String user) {
        
        a=bfm.readScoresFile(path, n);
        arg = path;
        testname = n;
        us=user;
        aq = bfm.readQuestionFile(arg, testname);
        aa = bfm.readAnswerFile(arg, testname);
        ndomande = aq.size();
        nrisposte = aa.size();
        ...
        System.out.println(aq.get(0).getImagepath());
    ...
    public class taskPerformer implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if(s==00 && m==00){
                ...
                String s=us+" : "+punti+" "+date;
                a.add(s);
                bfm.writeScoresFile(arg,testname,a);
                ...
                if(aq.get(idomande-1).isTwoanswers()==true){
                    ...
                    if(answer1_radiobutton.isSelected()){
                        if(aa.get(irisposte-4).isCorrect()==true){
                            ...
                            System.out.println(aa.get(irisposte).getAnswertext());
